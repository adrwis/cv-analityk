...
const GDPR_PL = 'Wyrażam zgodę na przetwarzanie moich danych osobowych zawartych w niniejszym dokumencie do celów rekrutacji, zgodnie z Ustawą o ochronie danych osobowych z dnia 10 maja 2018 r. (Dz.U. 2018 poz. 1000) oraz Rozporządzeniem Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia 27 kwietnia 2016 r. (RODO).';
...
const data = {
  ...
  sectionLabels: {
    ...
    toolbox: 'Kompetencje techniczne',
    contact: 'Kontakt',
    coreSkills: 'Kluczowe umiejętności',
    languages: 'Języki',
    education: 'Wykształcenie',
    certifications: 'Certyfikaty',
    method: 'Specjalizacja',
  },
  sidebarSkills: [
  ...
  stats: [
    { num: '8+', lbl: 'Lat<br>BI / Raportowanie' },
    { num: '5+', lbl: 'Lat Power BI<br>Praktycznie' },
    { num: '3', lbl: 'Źródła korpor.<br>Zintegrowane (HSBC)' },
    { num: '14', lbl: 'Działów<br>Global Transition' },
  ],
  jobs: [
    {
      title: 'Starszy Analityk · BI i Zarządzanie Wydajnością',
      ...
      impact: 'Zastąpiłam rozproszone raporty Excel zarządzaną warstwą semantyczną Power BI: szybsze odświeżanie, spójne definicje KPI i bezpośrednia adopcja na poziomie zarządu.',
    },
    {
      title: 'Programista BI w HSBC',
      meta: 'Alten Polska Sp. z o.o. · Bankowość · Kraków / Zdalnie',
      period: 'Lip 2022 - Kwi 2024',
      bullets: [
        '<b>Modele semantyczne i dashboardy Power BI</b> dla 5-osobowego zespołu w globalnym banku HSBC: prognozowanie i alokacja kosztów osobowych w <b>puli 15 mln USD oraz ~40 projektach IT</b>.',
        'Integrowałam <b>3 korporacyjne źródła danych</b> (Clarity, GPDM, Cognos) w jednolity model danych Power BI z użyciem <b>SQL, Power Query i DAX</b>.',
        'Współpracowałam z zespołami architektury IT i platform danych; zarządzanie wydaniami, dokumentacja i szkolenia użytkowników.',
      ],
      impact: 'Zdiagnozowałam fragmentację procesu w zespole 5 analityków i zbudowałam zintegrowane modele wieloźródłowe; dokumentacja i szkolenia umożliwiły przejście na pracę samoobsługową w Power BI.',
    },
    {
      title: 'Programista Smartsheet · PowerApps',
      meta: 'Zimmer Biomet Polska · Wyroby medyczne · Warszawa',
      period: 'Cze 2021 - Cze 2022',
      bullets: [
        'Raportowanie postępu <b>Global Transition</b> w <b>14 działach</b>: dashboardy KPI, definicje semantyczne, nadzór nad strukturą danych.',
        'Zbudowałam aplikację <b>Continuous Improvement</b> w PowerApps: rejestracja usprawnień procesów, integracja z SharePoint, nadzór nad obiegiem.',
        'Szkoliłam globalne zespoły i programistów Smartsheet; zarządzanie wydaniami narzędzia.',
      ],
      impact: 'Zastąpiłam rozproszone arkusze Excel jednym źródłem PowerApps dla usprawnień procesów w 14 działach wyrobów medycznych; iteracyjne wydania, komunikacja zmian, szkolenia.',
    },
    {
      title: 'Programista BI / Analityk · Facility Manager',
      meta: 'ISS Facility Services · Zarządzanie projektami · Warszawa',
      period: 'Wrz 2018 - Maj 2021',
      bullets: [
        'Dashboardy <b>Power BI</b> i SharePoint dla <b>Zarządu</b>: KPI biznesowe i operacyjne w wielu liniach usług.',
        'Facility Management dla <b>klienta farmaceutycznego</b>: budżetowanie kosztów, prognozowanie, uzgodnienia finansowe w środowisku regulowanym.',
        'Automatyzacja procesów w <b>Power Automate + SharePoint + Power BI</b>: obieg faktur dla globalnego klienta bankowego; integracja z istniejącymi platformami danych.',
        'Zarządzałam zespołami 4-15 osób i audytami wewnętrznymi; projekt innowacyjny <b>Novatorium</b> na Power Platform.',
      ],
      impact: 'Prognozowanie budżetu usług dla klienta farmaceutycznego oraz pełna automatyzacja obiegu faktur klienta bankowego: integracja Power Automate + SharePoint + Power BI zastąpiła procesy manualne.',
    },
    {
      title: 'Junior Project Manager',
      meta: 'Jeronimo Martins (Lizbona i Warszawa) · Robert Bosch (Warszawa) · Program rozwojowy',
      period: 'Lut 2016 - Sie 2018',
      bullets: [
        'Międzynarodowe doświadczenie projektowe w <b>Portugalii i Polsce</b>: Employer Branding, Store Excellence, obsługa klienta, logistyka.',
      ],
      impact: '',
    },
  ],
  education: [
    { yr: '2020-2021', deg: 'Studia podyplomowe · Quality Manager', inst: 'Szkoła Główna Handlowa (SGH)<br><em>Lean Management · Six Sigma · Kaizen</em>' },
    ...
    { yr: '2009-2010', deg: 'Wymiana Rotary · Brazylia', inst: 'ANGLO High School, Penápolis' },
  ],
  certs: [
...
function renderJobs(jobs) {
  return jobs.map(j => `
    <article class="job">
      ...
      ${j.impact ? `<div class="impact"><span class="tag">Efekt ·</span>${j.impact}</div>` : ''}
    </article>`).join('');
}
