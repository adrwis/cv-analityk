...
// KPIs & compliance, stakeholder work across IT & Finance, internal audit support, regulated-environment
...
const data = {
  ...
  jobs: [
    {
      ...
      bullets: [
        ...
        'Delivered <b>dashboards and scorecards</b> for the CFO and Financial Directors on agreed KPIs.',
      ],
    ...
    },
    {
      ...
      bullets: [
        ...
        'Delivered reporting on <b>cost allocation</b> across a $15M pool and ~40 IT projects; enabled self-service through documentation and training.',
      ],
  ...
  toolbox: {
    quality: { title: 'Data Quality & Validation', items: 'validation rules and checks · monitoring data quality · tracing breaks and inconsistencies across systems · metric logic and acceptance criteria' },
    ...
    reporting: { title: 'Reporting & Dashboards', items: 'Power BI dashboards on KPIs and compliance status · executive and Board reporting · documentation of data flows' },
