// Tailored CV (EN) — Senior Power BI Developer (Binary by Loop Future, Swiss enterprise contract).
// Focus: senior Power BI/DAX/RLS/Power Query/SQL, large complex datasets, semantic models, workspace governance, contract-ready.
...
const data = {
  ...
  sidebarSkills: [
    ...
    { name: 'DAX · Advanced Measures', lvl: 'Advanced', pct: 92 },
    { name: 'Power Query (M) · ETL', lvl: 'Advanced', pct: 90 },
    { name: 'RLS · Workspace Governance', lvl: 'Advanced', pct: 85 },
    { name: 'SQL · Complex Datasets', lvl: 'Advanced', pct: 88 },
  ...
  stats: [
    ...
    { num: '3', lbl: 'Enterprise Sources<br>Consolidated (HSBC)' },
  ...
  jobs: [
    {
      ...
      bullets: [
        'Design and maintenance of <b>Power BI semantic models, dashboards and reports</b> for CFO and Financial Directors: <b>DAX measures</b>, relationships, drill-through, KPI hierarchies.',
        '<b>Power Query (M)</b> transformations and <b>Alteryx ETL</b> for multi-source consolidation; <b>SQL</b> queries against enterprise data warehouses; performance optimisation of refresh cycles.',
        'Gathering business requirements, defining KPIs and translating them into <b>data models and measures</b>; documentation of metric definitions and acceptance criteria.',
        'Day-to-day support: troubleshooting, performance tuning, training on Power BI and self-service analytics for business stakeholders.',
      ],
    ...
    },
    {
      ...
      bullets: [
        '<b>Power BI semantic models and dashboards</b> for a 5-analyst team at global bank HSBC: people-cost forecasting and allocation across <b>$15M pool and ~40 IT projects</b>.',
        'Integration of <b>3 enterprise data sources</b> (Clarity, GPDM, Cognos) into a unified Power BI data model using <b>SQL, Power Query and DAX</b>.',
        'Collaboration with IT architecture and data platform teams; release management, documentation and user training for the BI suite.',
      ],
    ...
    },
    {
      ...
      bullets: [
        'Reporting <b>Global Transition</b> progress across <b>14 departments</b>: KPI dashboards, semantic definitions, governance of data structure.',
        'Built a <b>Continuous Improvement</b> PowerApps application: process improvement capture, SharePoint integration, workflow governance.',
    ...
    },
    {
      ...
      bullets: [
        ...
        'Facility Management for a <b>pharmaceutical client</b>: cost budgeting, forecasting, financial reconciliation in a regulated environment.',
  ...
  method: [
    'Semantic modelling and DAX',
    'Power Query (M) transformations',
    'RLS and workspace governance',
    'Performance optimisation',
    'Stakeholder requirements',
    'Documentation and training',
  ],
  toolbox: {
    bi: { title: 'Power BI Development', items: 'Power BI Desktop and Service · semantic models · advanced DAX (calculated tables, measures, hierarchies) · Power Query (M) · row-level security · workspace governance · ready for Microsoft Fabric' },
    db: { title: 'Databases & SQL', items: 'SQL Advanced (LabMasters 2025) · complex enterprise datasets · star schema · dimensional modelling · Power Query (M) · data warehouses · query optimisation' },
    etl: { title: 'ETL & Integration', items: 'Alteryx · Power Query · multi-source consolidation (Clarity, GPDM, Cognos, SharePoint, Excel) · API integrations · ERP-sourced data · enterprise data platform collaboration' },
    governance: { title: 'Security & Governance', items: 'Row-level security (RLS) · workspace access control · user permissions · data protection best practices · release management · documentation standards' },
    requirements: { title: 'Requirements & Analysis', items: 'Business requirement gathering · KPI definition · stakeholder workshops · functional and technical specifications · acceptance criteria · executive reporting design' },
...
const offer = {
  fileName: 'AG_Senior_Power_BI_Developer.pdf',
  lang: 'en',
  title: 'Senior Power BI Developer &middot; Semantic Models &amp; Governance',
  summary: 'Senior BI specialist with <strong>8+ years in Business Intelligence and reporting</strong> and <strong>5+ years hands-on Power BI</strong> across regulated international environments: banking (<strong>HSBC</strong>), cybersecurity (<strong>Trustwave</strong>), medical devices (Zimmer Biomet) and a pharmaceutical client at ISS Facility Services. Strong in <strong>semantic models, advanced DAX, Power Query (M), Row-Level Security and workspace governance</strong>. <strong>SQL Advanced</strong> (LabMasters 2025) with experience working with <strong>large complex enterprise datasets</strong>: multi-source consolidation (Clarity, GPDM, Cognos, SharePoint, ERP). Proven in <strong>gathering business requirements, defining KPIs and translating them into scalable Power BI solutions</strong>. Contract-ready, comfortable working independently across multiple stakeholders and time zones.',
  skillOrder: ['bi', 'db', 'etl', 'governance', 'requirements', 'office'],
};
