...
const WEB_PREVIEW = path.join(outputDir, 'crossing_hurdles_web_preview.html');
const RENDER_HTML = path.join(outputDir, '_crossing_hurdles_render.html');
const PDF_FILE = path.join(outputDir, 'AG_Crossing_Hurdles_BI_Excel_Analyst.pdf');
const VIDEO_FILE = path.join(outputDir, 'AG_Crossing_Hurdles_CV_background.webm');

const WEB_URL = 'https://adrwis.github.io/cv-analityk/';
const HEADLINE = 'Advanced Excel: Power Query, PivotTables, data modeling. Structuring &amp; validating large datasets, incl. for AI training.';
  ...
  <main class="cv-analyst__container">
    ...
    <section class="cv-analyst__hero">
      <div class="cv-analyst__hero-content">
        ...
        <a class="cv-analyst__role-link" href="${WEB_URL}" target="_blank" rel="noopener">Business Intelligence Analyst · Excel &amp; AI Data</a>
        <p class="cv-analyst__headline" id="headline">${HEADLINE}</p>
        <p class="cv-analyst__tagline">8+ years turning messy, multi-source data into <strong>clean, validated Excel models and BI reporting</strong> across banking, cybersecurity and facilities (HSBC, Trustwave, ISS). <strong>Advanced Excel (Power Query, PivotTables, data modeling)</strong>, rigorous data validation, and hands-on <strong>AI tools (Claude)</strong>: a strong fit for structuring and evaluating data and outputs for AI.</p>
    ...
    <section class="cv-analyst__section" id="target-role">
      <div class="cv-analyst__section-header"><div class="cv-analyst__section-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><h2 class="cv-analyst__section-title">Target role · Business Intelligence Analyst (Excel) · AI Data</h2></div>
      <p style="color:var(--ca-text-muted);max-width:72ch">Fully-remote contract fit: <strong>advanced Excel (Power Query, PivotTables, data modeling)</strong>, structuring, cleaning and validating large datasets, and creating reports/dashboards. Daily hands-on <strong>AI tools (Claude)</strong> plus a track record of <strong>data-quality and validation</strong>: strong for preparing and evaluating data and AI-generated outputs against quality rubrics. Fluent English, self-directed, async.</p>
    </section>
    ...
    <section class="cv-analyst__section" id="core-skills">
      ...
      <div class="cv-analyst__skills-grid">
        <div class="cv-analyst__skill-group cv-analyst__skill-group--ai">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg><span>Excel &amp; Data Prep</span></h3>
          ${skillBar('Advanced Excel (Power Query, PivotTables)', 95, 'expert')}
          ${skillBar('Data Cleaning &amp; Validation', 92, 'expert')}
          ${skillBar('Data Modeling &amp; Structuring', 88, 'advanced')}
          ${skillBar('Large-dataset Analysis (Excel / Sheets)', 88, 'advanced')}
        ...
        <div class="cv-analyst__skill-group">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3M21 5v14c0 1.66-4 3-9 3s-9-1.34-9-3V5"/></svg><span>AI Data &amp; Automation</span></h3>
          ${skillBar('Structuring &amp; Validating Data for AI', 88, 'advanced')}
          ${skillBar('AI Tools (Claude) &amp; Output Review', 85, 'advanced')}
          ${skillBar('Power Automate · Process Improvement', 82, 'advanced')}
          <div class="cv-analyst__tags cv-analyst__tags--spaced" style="margin-top:.6rem">
            <span class="cv-analyst__tag">Power Query</span><span class="cv-analyst__tag">PivotTables</span><span class="cv-analyst__tag">SQL</span><span class="cv-analyst__tag">Alteryx</span><span class="cv-analyst__tag">Google Sheets</span>
          </div>
        </div>
      </div>

      <div class="cv-analyst__terminal">
        <div class="cv-analyst__terminal-header"><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--red" aria-hidden="true"></span><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--yellow" aria-hidden="true"></span><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--green" aria-hidden="true"></span><span class="cv-analyst__terminal-title">ai-data</span></div>
        <div class="cv-analyst__terminal-body">
          <div><span class="prompt">$</span> <span class="function">validate</span> <span class="string">"dataset for AI training"</span></div>
          <div><span class="comment">&gt; Cleaning &amp; structuring rows in Excel...</span></div>
          <div><span class="comment">&gt; Checking against quality rubric...</span></div>
          <div><span class="output">&#10003; Large dataset validated</span></div>
          <div><span class="output">&#10003; Factual &amp; format errors flagged</span></div>
          <div><span class="output">&gt;&gt;&gt; structured feedback delivered</span></div>
        </div>
      </div>
    </section>
