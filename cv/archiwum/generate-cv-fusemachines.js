...
const WEB_PREVIEW = path.join(outputDir, 'fusemachines_web_preview.html');
const RENDER_HTML = path.join(outputDir, '_fusemachines_render.html');
const PDF_FILE = path.join(outputDir, 'AG_Fusemachines_Data_Analyst.pdf');
const VIDEO_FILE = path.join(outputDir, 'AG_Fusemachines_CV_background.webm');

const WEB_URL = 'https://adrwis.github.io/cv-analityk/';
const HEADLINE = 'End-to-end Power BI &amp; SQL on the Microsoft BI stack: DAX, Power Query, Power Automate; dashboards leaders rely on.';
  ...
  <main class="cv-analyst__container">
    ...
    <section class="cv-analyst__hero">
      <div class="cv-analyst__hero-content">
        ...
        <a class="cv-analyst__role-link" href="${WEB_URL}" target="_blank" rel="noopener">Senior Data Analyst · Microsoft BI Stack</a>
        <p class="cv-analyst__headline" id="headline">${HEADLINE}</p>
        <p class="cv-analyst__tagline">8+ years building <strong>Power BI dashboards, DAX models and SQL analytics</strong> on the Microsoft BI stack across banking, cybersecurity and facilities (HSBC, Trustwave, ISS). I turn complex, multi-source data into <strong>validated, decision-ready reporting</strong>, automate with <strong>Power Automate</strong>, and mentor analysts.</p>
    ...
    <section class="cv-analyst__section" id="target-role">
      <div class="cv-analyst__section-header"><div class="cv-analyst__section-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><h2 class="cv-analyst__section-title">Target role · Senior Data Analyst (Microsoft BI Stack)</h2></div>
      <p style="color:var(--ca-text-muted);max-width:72ch">Remote fit on the <strong>Microsoft BI stack</strong>: Power BI, advanced <strong>DAX</strong>, Power Query (M), <strong>SQL</strong> and Power Automate, with semantic / data modeling and rigorous data validation. Comfortable translating business needs into solutions, <strong>mentoring junior analysts</strong> and working Agile with stakeholders. (Growth areas: Azure, DevOps/Git.)</p>
    </section>
    ...
    <section class="cv-analyst__section" id="core-skills">
      ...
      <div class="cv-analyst__skills-grid">
        <div class="cv-analyst__skill-group cv-analyst__skill-group--ai">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg><span>BI &amp; Microsoft Stack</span></h3>
        ...
        <div class="cv-analyst__skill-group">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M18 20V10M12 20V4M6 20v-6"/></svg><span>Data &amp; SQL</span></h3>
          ${skillBar('SQL (incl. SQL Server)', 80, 'advanced')}
          ${skillBar('Semantic / Data Modeling', 82, 'advanced')}
          ${skillBar('Data Validation &amp; Quality', 88, 'advanced')}
        </div>
        <div class="cv-analyst__skill-group">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3M21 5v14c0 1.66-4 3-9 3s-9-1.34-9-3V5"/></svg><span>Delivery &amp; AI</span></h3>
          ${skillBar('Mentoring &amp; Team Leadership', 85, 'advanced')}
          ${skillBar('Agile · Stakeholder Communication', 85, 'advanced')}
          ...
          <div class="cv-analyst__tags cv-analyst__tags--spaced" style="margin-top:.6rem">
            <span class="cv-analyst__tag">SQL Server</span><span class="cv-analyst__tag">Power Automate</span><span class="cv-analyst__tag">SharePoint</span><span class="cv-analyst__tag">Cognos</span><span class="cv-analyst__tag">Alteryx</span>
          </div>
        </div>
      </div>
      ...
      <div class="cv-analyst__terminal">
        ...
        <div class="cv-analyst__terminal-body">
          <div><span class="prompt">$</span> <span class="function">refresh</span> <span class="string">"executive dashboard"</span></div>
