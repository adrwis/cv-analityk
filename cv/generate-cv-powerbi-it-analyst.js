// Tailored CV (EN) — Power BI IT Analyst.
// Focus: Power BI reports + semantic models + DAX + SQL + collaboration with data engineering / architecture.
// Target: international env, regulated (GxP/Pharma-adjacent via Zimmer Biomet + ISS pharma client), enterprise data sources.
...
const data = {
  ...
  sidebarSkills: [
    { name: 'Power BI · Dashboards', lvl: 'Expert', pct: 95 },
    { name: 'DAX · Semantic Models', lvl: 'Advanced', pct: 90 },
    { name: 'SQL · Power Query (M)', lvl: 'Advanced', pct: 88 },
    { name: 'Data Modeling · ETL', lvl: 'Advanced', pct: 85 },
    { name: 'Stakeholder Engagement', lvl: 'Expert', pct: 92 },
    { name: 'Documentation · Training', lvl: 'Advanced', pct: 88 },
    { name: 'Alteryx · Power Platform', lvl: 'Advanced', pct: 82 },
  ],
  languages: [
  ...
  jobs: [
    {
      ...
      bullets: [
        'Design and maintenance of <b>Power BI reports, dashboards and semantic models</b> for CFO and Financial Directors: KPI hierarchies, DAX measures, relationships, drill-through.',
        'Translation of business requirements into <b>functional and technical specifications</b>; data modeling, validation rules and acceptance criteria for executive reporting.',
        '<b>SQL</b> queries against enterprise data sources, <b>ETL in Alteryx and Power Query (M)</b>; data quality monitoring and performance optimization of refresh cycles.',
        'Day-to-day support for business users: troubleshooting, performance tuning, training on Power BI and self-service analytics.',
      ],
    ...
    },
    {
      ...
      bullets: [
        'Power BI semantic models and dashboards for a <b>5-analyst team</b> at global bank HSBC; <b>forecasting and people-cost allocation</b>: $15M people-cost pool across ~40 IT projects.',
        'Integration of <b>3 enterprise data sources</b> (Clarity, GPDM, Cognos) into a unified Power BI data model: <b>SQL, Power Query, DAX</b>.',
        'Collaboration with IT architecture and data platform teams; documentation, release management and user training for the BI suite.',
      ],
      impact: 'Diagnosed process fragmentation across 5 analysts and built integrated multi-source semantic models; documentation + training enabled the shift to self-service Power BI work.',
    },
    {
      ...
      bullets: [
        'Reporting <b>Global Transition</b> progress across <b>14 departments</b>: KPI dashboards, semantic definitions, data structure governance.',
        'Built a <b>Continuous Improvement</b> PowerApps application: process improvement capture, SharePoint integration, business workflow.',
        'User training for global teams and Smartsheet developers; release management for tooling rollout.',
      ],
      impact: 'Replaced scattered Excel sheets with a single PowerApps source for process improvements across 14 medical-device departments; iterative releases, change communication, user training.',
    },
    {
      ...
      bullets: [
        ...
        'Facility Management for a <b>pharmaceutical client</b>: cost budgeting, forecasting, financial reconciliation of services (regulated environment).',
        'Process automation in Power Automate + SharePoint + Power BI: invoice flow for a global banking client; integration with existing data platforms.',
        'Managing teams of 4-15 people and internal audits; <b>Novatorium</b> innovation project on the Power Platform.',
      ],
      impact: 'Pharmaceutical client service budget forecasting + full invoice flow automation for the banking client: Power Automate + SharePoint + Power BI integration replaced manual processes.',
    },
    {
  ...
  toolbox: {
    bi: { title: 'Power BI & Reporting', items: 'Power BI Desktop and Service · DAX (advanced) · semantic models · calculated columns · hierarchies · row-level security · KPI dashboards · Cognos · ready for Microsoft Fabric (Lakehouse, semantic models)' },
    db: { title: 'Databases & SQL', items: 'SQL Advanced (LabMasters 2025) · Power Query (M) · data modeling · star schema · warehouses · ready to extend to Databricks and SAP-sourced datasets' },
    etl: { title: 'ETL & Integrations', items: 'Alteryx · Power Query · multi-source consolidation (Clarity, GPDM, Cognos, SharePoint, Excel) · API integrations · enterprise data platform collaboration' },
    requirements: { title: 'Requirements & Analysis', items: 'Functional and technical specifications · business requirement gathering · workshops with SMEs · acceptance criteria · validation rules · documentation' },
    governance: { title: 'Governance & Support', items: 'Reporting accuracy and performance · data quality monitoring · release management · user training · troubleshooting · self-service enablement' },
    office: { title: 'Office & Platform', items: 'Excel advanced (formulas, Power Query, Power Pivot) · SharePoint · Power Automate · PowerApps · MS Office Suite · regulated-environment exposure (medical devices, pharma)' },
  },
  gdpr: GDPR_EN,
...
const offer = {
  fileName: 'AG_Power_BI_IT_Analyst.pdf',
  lang: 'en',
  title: 'Power BI IT Analyst &middot; Semantic Models &amp; Business Analytics',
  summary: 'BI Analyst with <strong>8+ years</strong> in regulated international environments: banking (<strong>HSBC</strong>), medical devices (Zimmer Biomet, 14-department Global Transition) and a <strong>pharmaceutical client</strong> at ISS Facility Services. <strong>Power BI expert</strong> with <strong>5+ years hands-on</strong>: semantic models, DAX, relationships, hierarchies, KPI dashboards for CFO, Financial Directors and the Board. Strong in <strong>SQL Advanced</strong> (LabMasters 2025), Power Query (M), data modeling and ETL in <strong>Alteryx</strong>; multi-source integration (Clarity, GPDM, Cognos, SharePoint). Customer-oriented, with proven experience in <strong>requirements gathering, documentation, user training, release support and troubleshooting</strong>. Comfortable working independently across multiple priorities in international teams.',
