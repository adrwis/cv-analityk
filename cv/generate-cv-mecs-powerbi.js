...
const cvData = {
  en: {
    fileName: 'AG_Senior Power BI Developer_MECS_EN.pdf',
    ...
    jobs: [
      {
        ...
        bullets: [
          ...
          'Maintain data integrity across reporting models: validation checks, source reconciliation, and standardised semantic definitions',
        ],
      },
      {
