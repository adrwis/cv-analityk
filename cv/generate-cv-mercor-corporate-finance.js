// Tailored CV (EN) - Corporate Finance Expert (Mercor, contract, remote, AI data evaluation).
// Focus: financial reporting & analysis accuracy/rigor, cost forecasting & allocation, complex financial data,
// benchmarking & structured feedback for AI research teams, hands-on AI builder (Claude agents).
...
const data = {
  ...
  sidebarSkills: [
    { name: 'Financial Reporting · Analysis', lvl: 'Expert', pct: 92 },
    { name: 'Financial Data Accuracy', lvl: 'Advanced', pct: 88 },
    { name: 'Cost Forecasting · Allocation', lvl: 'Advanced', pct: 88 },
    { name: 'Benchmarking · Evaluation', lvl: 'Advanced', pct: 82 },
    { name: 'AI Tools · Claude Agents', lvl: 'Advanced', pct: 85 },
    { name: 'Structured Feedback', lvl: 'Advanced', pct: 84 },
  ...
  method: [
    'Reporting accuracy and rigor',
    'Cost forecasting and allocation',
    'Benchmarks and structured feedback',
    'AI agents and automation',
    'Async, self-directed delivery',
    'Stakeholder storytelling',
  ],
  toolbox: {
    reporting: { title: 'Financial Reporting & Analysis', items: 'management and financial reporting · P&L and cost analysis · month-end inputs · variance, trend and driver analysis · reconciliation' },
    forecasting: { title: 'Cost & Forecasting', items: 'people-cost forecasting and allocation ($15M pool, ~40 IT projects) · budgeting · financial reconciliation · scenario and sensitivity views' },
    eval: { title: 'Evaluation & Benchmarking', items: 'assessing accuracy and rigour of financial reporting · developing benchmarks for analysis tasks · structured feedback to research teams · quality control' },
    ...
    comms: { title: 'Communication & Insight', items: 'turning complex financial data into clear, defensible insight · async, self-directed delivery · stakeholder storytelling · concise written communication' },
    domain: { title: 'Tools & Background', items: 'Power BI · SQL (Advanced) · Excel · Power Query (M) · clinical-psychology background (statistics, research methodology) · fast ramp-up in new domains' },
  },
  gdpr: GDPR_EN,
...
const offer = {
  fileName: 'AG_Mercor_Corporate_Finance_Expert.pdf',
  lang: 'en',
  title: 'Corporate Finance · Reporting & AI Evaluation',
  summary: 'Finance and data analyst with <strong>8+ years in financial reporting and analysis</strong> across banking, cybersecurity and facilities management (HSBC, Trustwave, ISS). I assess the <strong>accuracy and rigour of financial reporting</strong>, analyse <strong>complex financial data</strong>, and translate it into clear, defensible insight. At HSBC I delivered <strong>people-cost forecasting and allocation across a $15M pool and ~40 IT projects</strong>; at Trustwave I owned <strong>P&amp;L-relevant reporting for the CFO and Financial Directors</strong>; at ISS I led <strong>budgeting, forecasting and financial reconciliation</strong> in regulated environments. I build <strong>AI agents and automation with Claude</strong> in independent projects, so I can <strong>develop benchmarks and structured feedback to improve AI-generated financial analysis</strong>. Reliable working independently and asynchronously to deadline.',
  skillOrder: ['reporting', 'forecasting', 'eval', 'ai', 'comms', 'domain'],
};
