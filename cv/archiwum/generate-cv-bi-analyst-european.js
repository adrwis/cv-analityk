// Tailored CV (EN) — Business Intelligence Analyst (European Operations, Remote).
// Focus: Power BI expert + SQL + forecasting + executive stakeholder engagement.
// Target offer: Power BI dashboards, Microsoft Fabric, Dynamics 365 CRM, forecasting, European operations.
...
const photoPath = path.resolve(__dirname, '_photo_300.jpg');
...
const data = {
  ...
  sidebarSkills: [
    ...
    { name: 'Forecasting · Modeling', lvl: 'Advanced', pct: 88 },
    { name: 'SQL · Power Query (M)', lvl: 'Advanced', pct: 85 },
    { name: 'ETL · Alteryx · Integrations', lvl: 'Advanced', pct: 82 },
    { name: 'Power Platform · Automation', lvl: 'Advanced', pct: 85 },
    { name: 'C-level Reporting · KPI', lvl: 'Expert', pct: 92 },
    { name: 'Business Communication', lvl: 'Expert', pct: 92 },
  ],
  languages: [
  ...
  jobs: [
    {
      ...
      bullets: [
        'Designing <b>Power BI</b> dashboards for CFO and Financial Directors: single-view KPI monitoring, trend analysis and business performance analytics.',
        'Analysis of large and complex datasets: <b>SQL</b>, semantic modeling, reporting automation in <b>Power Query and Alteryx (ETL)</b>.',
        'Translating financial data into strategic recommendations for C-level stakeholders; cross-functional collaboration with Finance, Operations, IT.',
      ],
      impact: 'Replaced manual Excel reports with automated ETL flows and Power BI dashboards: shortened reporting cycle and full KPI consistency.',
    },
    {
      title: 'BI Analyst at HSBC',
      meta: 'Alten Polska Sp. z o.o. · Banking · Krakow / Remote',
      period: 'Jul 2022 - Apr 2024',
      bullets: [
        'Coordination of a <b>5-analyst team</b> at global bank HSBC; <b>forecasting and people-cost allocation</b>: <b>$15M people-cost pool</b> across ~40 IT projects.',
        'Designing BI reports and dashboards: <b>SQL, Power Query, Power BI</b>; data integration from 3 source systems (Clarity, GPDM, Cognos) into a unified model.',
        'Training teams on BI tools (Power BI, Power Query, Excel) and promoting self-service analytics.',
      ],
      impact: 'Audited the work of 5 analysts, diagnosed process fragmentation and built integrated multi-source flows; documentation, forecasting and training enabled the shift from manual consolidation to self-service work with data.',
    },
    {
      ...
      bullets: [
        'Reporting <b>Global Transition</b> progress for <b>14 departments</b>: KPI dashboards, semantic definitions, data structure.',
        'Built <b>Continuous Improvement</b> application in PowerApps: collecting process improvements, SharePoint integration.',
        'Tool training for global users and Smartsheet developers.',
      ],
      impact: 'Continuous Improvement application in PowerApps replaced scattered Excel sheets as a single source for submitting process improvements across 14 departments; iterative development, change communication and user training.',
    },
    {
      ...
      bullets: [
        'Dashboards and reports for the <b>Board</b>: Power BI and SharePoint; business and operational KPIs.',
        '<b>Facility Management</b> for a <b>pharmaceutical industry client</b>: managing services (events, cleaning, fleet, administration); financial settlement of services, <b>cost budgeting and forecasting</b>.',
        'Process automation: Power Automate, SharePoint, Power BI; invoice flow for a global banking sector client.',
        '<b>Budgeting, forecasting</b> and non-financial analysis; managing teams of <b>4-15 people</b> and internal audits.',
        '<b>Novatorium</b> project: innovation implementation using Power Platform.',
      ],
      impact: 'Service budget forecasting for the pharmaceutical client and full invoice flow automation for the banking client: Power Automate + SharePoint + Excel integration replaced manual processes.',
    },
    {
  ...
  method: [
    ...
    'Power BI dashboards for C-level',
    'SQL and semantic modeling',
    'ETL and multi-source integrations',
    'Reporting automation (Power Platform)',
    'Stakeholder management and communication',
  ],
  toolbox: {
    bi: { title: 'BI & Reporting', items: 'Power BI · DAX (advanced) · KPI dashboards · semantic modeling · Excel Power Pivot · Cognos · ready to extend to Microsoft Fabric (Lakehouse, semantic models)' },
    db: { title: 'Databases & SQL', items: 'SQL Advanced (LabMasters 2025) · Power Query (M) · ready for MySQL and BigQuery · data modeling · warehouses' },
    forecast: { title: 'Forecasting & Analysis', items: 'Cost and budget forecasting · scenario planning · resource allocation · trend analysis · KPI and cohort analytics' },
    etl: { title: 'ETL & Integrations', items: 'Alteryx · Power Query · multi-source consolidation (Clarity, GPDM, Cognos, SharePoint, Excel) · API · ready for Data Pipelines (Fabric)' },
    office: { title: 'Office & Productivity', items: 'Excel advanced (formulas, Power Query, Power Pivot) · Google Sheets · MS Office Suite · SharePoint' },
    automation: { title: 'Power Platform & CRM', items: 'Power Automate · PowerApps · Smartsheet · ready for Dynamics 365 CRM · workflow automation · AI Chatbot (REST API)' },
  },
  gdpr: GDPR_EN,
...
const offer = {
  fileName: 'AG_BI_Analyst_European_Operations.pdf',
  lang: 'en',
  title: 'Business Intelligence Analyst &middot; Forecasting &amp; Strategic Reporting',
  summary: 'BI Analyst with <strong>8+ years</strong> of experience analyzing data for regulated sectors: banking (<strong>HSBC, forecasting and people cost allocation</strong>), medical (Zimmer Biomet) and cybersecurity (Trustwave). Expert in <strong>Power BI and DAX</strong>, designing single-view dashboards for CFOs, Financial Directors and the Board. <strong>Forecasting, budgeting and scenario planning</strong> for IT portfolios and as Facility Manager for a pharmaceutical client (ISS). <strong>SQL Advanced</strong> (LabMasters 2025) with readiness for MySQL and BigQuery; ETL in Alteryx and Power Query, multi-source integration (Clarity, GPDM, Cognos, SharePoint). Power Platform (Automate, Apps) as a natural bridge to <strong>Microsoft Fabric and Dynamics 365 CRM</strong>. C-level stakeholder engagement, strategic presentations and self-service analytics enablement.',
  skillOrder: ['bi', 'forecast', 'db', 'etl', 'automation', 'office'],
};
