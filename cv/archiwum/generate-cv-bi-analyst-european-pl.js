// Tailored CV — Business Intelligence Analyst (European Operations, Remote).
// Profil: Power BI expert + SQL + forecasting + executive stakeholder engagement.
// Pod oferte: Power BI dashboards, Microsoft Fabric, Dynamics 365 CRM, forecasting, European operations.
...
const data = {
  ...
  sidebarSkills: [
    ...
    { name: 'Forecasting · Modelowanie', lvl: 'Zaawansowany', pct: 88 },
    { name: 'SQL · Power Query (M)', lvl: 'Zaawansowany', pct: 85 },
    { name: 'ETL · Alteryx · Integracje', lvl: 'Zaawansowany', pct: 82 },
    { name: 'Power Platform · Automatyzacja', lvl: 'Zaawansowany', pct: 85 },
    { name: 'Raportowanie C-level · KPI', lvl: 'Ekspert', pct: 92 },
  ...
  stats: [
    ...
    { num: '$15M', lbl: 'Portfel HSBC<br>Forecasting i Alokacja' },
    { num: '~40', lbl: 'Projektów IT<br>Budżetowanie' },
  ...
  jobs: [
    {
      ...
      bullets: [
        'Projektowanie dashboardów <b>Power BI</b> dla CFO i Financial Directors: monitoring KPI w jednym widoku, trend analysis i analizy wydajności biznesowej.',
        ...
        'Translacja danych finansowych na rekomendacje strategiczne dla stakeholderów C-level; współpraca międzydziałowa z Finance, Operations, IT.',
      ],
      impact: 'Zastąpiłam manualne raporty Excel zautomatyzowanymi przepływami ETL i dashboardami Power BI: skrócenie cyklu raportowego i pełna spójność KPI.',
    },
    {
      title: 'Analityk BI w HSBC · Lead Forecasting',
      meta: 'Alten Polska Sp. z o.o. · Bankowość · Kraków / Zdalnie',
      period: 'lip 2022 - kwi 2024',
      bullets: [
        'Koordynacja zespołu <b>5 analityków</b> w globalnym banku HSBC; <b>forecasting i alokacja kosztów personalnych</b> dla ~40 projektów IT o wartości <b>$15M</b>.',
        '<b>Budżetowanie, prognozowanie miesięczne i kwartalne, planowanie scenariuszowe</b>; rekomendacje optymalizacyjne i prezentacje wyników dla stakeholderów C-level.',
        'Projektowanie raportów i dashboardów BI: <b>SQL, Power Query, Power BI</b>; integracja danych z 3 systemów źródłowych (Clarity, GPDM, Cognos) w zunifikowany model.',
        'Szkolenia zespołów z narzędzi BI (Power BI, Power Query, Excel) i promowanie samoobsługowej analityki.',
      ],
      impact: 'Zaudytowałam pracę zespołu 5 analityków, zdiagnozowałam fragmentację procesów i zbudowałam zintegrowane przepływy wieloźródłowe; dokumentacja, forecasting i szkolenia pozwoliły przejść od manualnej konsolidacji do samodzielnej pracy z danymi.',
    },
    {
      ...
      impact: 'Aplikacja Continuous Improvement w PowerApps zastąpiła rozproszone arkusze Excel jako pojedyncze źródło zgłaszania usprawnień dla 14 departamentów; iteracyjny rozwój, komunikacja zmiany i szkolenia użytkowników.',
    },
    {
      title: 'Programista BI / Analityk · Facility Manager',
      ...
      bullets: [
        ...
        '<b>Facility Management</b> dla klienta z <b>branży farmaceutycznej</b>: zarządzanie serwisami (eventy, cleaning, flota, administracja); rozliczanie finansowe usług, <b>budżetowanie i forecasting</b> kosztów.',
        'Automatyzacja procesów: Power Automate, SharePoint, Power BI; obieg faktur dla globalnego klienta z sektora bankowego.',
        '<b>Budżetowanie, prognozowanie</b> i analizy niefinansowe; zarządzanie zespołami <b>4-15 osób</b> i audyty wewnętrzne.',
        'Projekt <b>Novatorium</b>: implementacja innowacji za pomocą Power Platform.',
      ],
      impact: 'Forecasting budżetu serwisów dla klienta farmaceutycznego oraz pełna automatyzacja obiegu faktur dla klienta bankowego: integracja Power Automate + SharePoint + Excel zastąpiła manualne przepływy.',
    },
    {
  ...
  method: [
    'Forecasting i planowanie scenariuszowe',
    'Dashboardy Power BI dla C-level',
    'SQL i modelowanie semantyczne',
    'ETL i integracje wieloźródłowe',
    'Automatyzacja raportowania (Power Platform)',
    'Stakeholder management i komunikacja',
  ],
  toolbox: {
    bi: { title: 'BI i Raportowanie', items: 'Power BI · DAX (zaawansowany) · dashboardy KPI · modelowanie semantyczne · Excel Power Pivot · Cognos · gotowość do Microsoft Fabric (Lakehouse, semantic models)' },
    ...
    forecast: { title: 'Forecasting i Analiza', items: 'Prognozowanie kosztów i budżetów · planowanie scenariuszowe · alokacja zasobów · analiza trendów · KPI i analizy kohortowe' },
    etl: { title: 'ETL i Integracje', items: 'Alteryx · Power Query · konsolidacja wieloźródłowa (Clarity, GPDM, Cognos, SharePoint, Excel) · API · gotowość do Data Pipelines (Fabric)' },
    ...
    automation: { title: 'Power Platform i CRM', items: 'Power Automate · PowerApps · Smartsheet · gotowość do Dynamics 365 CRM · workflow automation · AI Chatbot (REST API)' },
  },
  gdpr: GDPR_PL,
...
const offer = {
  ...
  lang: 'pl',
  title: 'Analityk Business Intelligence &middot; Forecasting i Raportowanie Strategiczne',
  summary: 'Analityczka BI z <strong>8+ latami</strong> doświadczenia w analizie danych dla sektorów regulowanych: bankowości (<strong>HSBC, forecasting i alokacja $15M portfela</strong>), medycznego (Zimmer Biomet) i cybersecurity (Trustwave). Ekspert <strong>Power BI i DAX</strong>, projektuję dashboardy KPI w jednym widoku dla CFO, Financial Directors i Zarządu. <strong>Forecasting, budżetowanie i planowanie scenariuszowe</strong> dla portfeli IT oraz dla klienta farmaceutycznego w roli Facility Managera (ISS). <strong>SQL Advanced</strong> (LabMasters 2025) z gotowością do MySQL i BigQuery; ETL w Alteryx i Power Query, integracja wieloźródłowa (Clarity, GPDM, Cognos, SharePoint). Power Platform (Automate, Apps) jako naturalny most do <strong>Microsoft Fabric i Dynamics 365 CRM</strong>. Stakeholder engagement na poziomie C-level, prezentacje strategiczne i wsparcie self-service analytics.',
