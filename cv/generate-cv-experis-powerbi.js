// Tailored to Experis Manpower Group — Senior Power BI Developer (Clinical Operations), 100% remote.
// Offer: Power BI + advanced DAX + data visualization, strong SQL, Jira, clinical-ops, code reviews,
// data modeling best practices, collaborate with data engineers. Offer language: EN -> CV in English.
// Same dark "Matrix" site aesthetic as the other cv/ generators.
// Hero: role title as its own line + a branded "cv-analyst" link to the live site.
// Builds: experis_powerbi_web_preview.html, the 2-page PDF (<=2MB) and a short webm.
...
const WEB_PREVIEW = path.join(outputDir, 'experis_powerbi_web_preview.html');
const RENDER_HTML = path.join(outputDir, '_experis_powerbi_render.html');
const PDF_FILE = path.join(outputDir, 'AG_Experis_Senior_Power_BI_Developer.pdf');
const VIDEO_FILE = path.join(outputDir, 'AG_Experis_Senior_Power_BI_Developer_CV_background.webm');

const WEB_URL = 'https://adrwis.github.io/cv-analityk/';
const ROLE = 'Senior Power BI Developer · Clinical Operations';
const HEADLINE = 'Power BI dashboards that turn complex clinical &amp; operational data into decisions: advanced DAX, data visualization, strong SQL.';
...
<title>CV — Adriana Guściora · Senior Power BI Developer (Clinical Operations)</title>
...
<style>
  ...
  /* role title under the name — itself a link to the live online CV */
...
<div class="cv-analyst" id="cv-analyst" data-mode="dark">
  ...
  <nav class="cv-analyst__topbar" aria-label="bar">
    <span class="cv-analyst__topbar-title">Adriana Guściora | Senior Power BI Developer · Clinical Operations</span>
  ...
  <main class="cv-analyst__container">
    ...
    <section class="cv-analyst__hero">
      <div class="cv-analyst__hero-content">
        ...
        <p class="cv-analyst__tagline">8+ years building <strong>Power BI dashboards, advanced DAX models and SQL analytics</strong> on complex, multi-source data across healthcare-adjacent, banking and cybersecurity settings (Zimmer Biomet, ISS, HSBC, Trustwave). Strong <strong>SQL, data visualization and Jira</strong>; I translate business and clinical requirements into clear, interactive reports.</p>
    ...
    <section class="cv-analyst__section" id="target-role">
      <div class="cv-analyst__section-header"><div class="cv-analyst__section-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg></div><h2 class="cv-analyst__section-title">Target role · Senior Power BI Developer (Clinical Operations)</h2></div>
      <p style="color:var(--ca-text-muted);max-width:72ch">100% remote fit: <strong>Power BI with advanced DAX</strong> and compelling <strong>data visualization</strong>, backed by <strong>strong SQL</strong> and <strong>Jira</strong>. I translate business and technical requirements into intuitive dashboards, follow data-modeling best practices and collaborate with data engineers. Healthcare-adjacent background (Zimmer Biomet medical devices, ISS pharma client) suits clinical operations. Polish (native) &amp; English (C1).</p>
    </section>
    ...
    <section class="cv-analyst__section">
      ...
      ${job('Senior Finance Analyst · Performance Management', 'Oct 2024 – Mar 2026', 'Trustwave Sp. z o.o. · Cybersecurity · Warsaw / Remote', [
        'Built and maintained <strong>Power BI dashboards and reports</strong> on multi-source financial and cost data used daily by Financial Directors and the CFO (advanced DAX, Power Query, SQL).',
        'Translated business requirements into <strong>intuitive, visually compelling dashboards</strong>; <strong>prepared and transformed data with Alteryx and SQL</strong>, safeguarding accuracy through validation and reconciliation.',
        '<strong>Automated repetitive reporting</strong> with Power Query, Power Automate and AI tools.',
      ], 'Diagnosed bottlenecks in monthly reporting, redesigned the data model and report layer, produced before/after documentation and delivered hands-on training across the full toolset (Power BI, DAX, Power Query, SQL, Alteryx).')}
      ${job('Power BI / Finance Analyst at HSBC · Cost Controlling', 'Jul 2022 – Apr 2024', 'Alten Polska Sp. z o.o. · Banking · Cracow / Remote', [
        'Integrated <strong>3 enterprise systems</strong> (Clarity, GPDM, Cognos) into one data model, <strong>cleaning and preparing the data with SQL (Access) and Power Query (Excel)</strong>, to build a <strong>single source of truth</strong> for a 5-analyst team.',
        'Designed <strong>interactive Power BI dashboards and DAX measures</strong> on a star-schema model, turning multi-source data into clear, self-service reports for stakeholders.',
      ], 'Standardised the reporting of a 5-analyst team on a shared star-schema model and Power BI layer, ran code/model reviews and trained everyone to operate the upgraded toolset confidently.')}
      ${job('Operations / Data Analyst · Global Transition', 'Jun 2021 – Jun 2022', 'Zimmer Biomet Polska · Medical Devices · Warsaw / Remote', [
        '<strong>Built KPI dashboards across 14 departments</strong> on shared data definitions and structured data governance (tool: Smartsheet; medical-device / clinical-adjacent environment).',
        'Created spreadsheet- and SharePoint-based workflows (PowerApps + Power Automate); validated data across global teams.',
      ], 'Designed and rolled out a new generation of dashboards reporting Global Transition migration progress for 14 departments, trained developers and end users, drove iterative dashboard improvements and owned change communication around each release.')}
      ${job('BI / Finance Analyst · Controlling &amp; Operations', 'Sep 2018 – May 2021', 'ISS Facility Services · Project Management · Warsaw · On-site / Remote', [
        'Board-level <strong>cost and operational KPI dashboards</strong> (Power BI + SharePoint) for a regulated <strong>pharmaceutical client</strong>: controlling reporting, variance analysis and internal audits; <strong>managed teams of 4–15</strong>.',
        '<strong>Automated</strong> invoice-flow data for a global banking client (Power Automate, SharePoint, Excel).',
      ], 'Owned the project to streamline invoice flow for a global banking client end-to-end, produced full documentation and trained internal team and client stakeholders. In parallel led the Novatorium initiative across the Polish branch (PowerApps, Power BI, SharePoint).')}
    ...
    <section class="cv-analyst__section" id="core-skills">
      ...
      <div class="cv-analyst__skills-grid">
        <div class="cv-analyst__skill-group cv-analyst__skill-group--ai">
          ...
          ${skillBar('Advanced DAX', 90, 'expert')}
          ${skillBar('Data Visualization', 92, 'expert')}
        ...
        <div class="cv-analyst__skill-group">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M18 20V10M12 20V4M6 20v-6"/></svg><span>SQL &amp; Data Modeling</span></h3>
          ${skillBar('SQL (querying &amp; optimization)', 82, 'advanced')}
          ${skillBar('Data Modeling (star schema)', 85, 'advanced')}
          ${skillBar('Data Validation &amp; Quality', 88, 'advanced')}
        </div>
        <div class="cv-analyst__skill-group">
          <h3><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3M21 5v14c0 1.66-4 3-9 3s-9-1.34-9-3V5"/></svg><span>Delivery &amp; Domain</span></h3>
          ${skillBar('Jira · Agile Delivery', 85, 'advanced')}
          ${skillBar('Stakeholder &amp; Requirements', 88, 'advanced')}
          ${skillBar('AI Tools (Claude Code)', 85, 'advanced')}
          <div class="cv-analyst__tags cv-analyst__tags--spaced" style="margin-top:.6rem">
            <span class="cv-analyst__tag">SQL Server</span><span class="cv-analyst__tag">Jira</span><span class="cv-analyst__tag">Confluence</span><span class="cv-analyst__tag">SharePoint</span><span class="cv-analyst__tag">Healthcare / Medtech</span>
          </div>
        </div>
      </div>

      <div class="cv-analyst__terminal">
        <div class="cv-analyst__terminal-header"><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--red" aria-hidden="true"></span><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--yellow" aria-hidden="true"></span><span class="cv-analyst__terminal-dot cv-analyst__terminal-dot--green" aria-hidden="true"></span><span class="cv-analyst__terminal-title">power-bi · clinical-ops</span></div>
        <div class="cv-analyst__terminal-body">
          <div><span class="prompt">$</span> <span class="function">refresh</span> <span class="string">"clinical-ops dashboard"</span></div>
          <div><span class="comment">&gt; Querying SQL Server...</span></div>
          <div><span class="comment">&gt; Building DAX measures &amp; star-schema model...</span></div>
          <div><span class="output">&#10003; Data validated, single source of truth</span></div>
          <div><span class="output">&#10003; Dashboard published, code-reviewed</span></div>
          <div><span class="output">&gt;&gt;&gt; insights delivered to leaders</span></div>
        </div>
      </div>
    </section>
    ...
    <section class="cv-analyst__section">
      ...
      <div class="cv-analyst__tags cv-analyst__tags--certs">
        <span class="cv-analyst__tag">Advanced Business Analytics in Power BI · LabMasters, 2026</span>
...
(function(){
  ...
  var phrases = ['Power BI + advanced DAX','Data visualization that lands','Star-schema data models','SQL on multi-source data','Clinical & operational dashboards'];
...
(async () => {
  ...
  if (process.env.SHOT) await page.screenshot({ path: path.join(outputDir, '_experis_check.png'), fullPage: true });
  ...
  const tmpVideoDir = path.join(outputDir, '_vid_tmp_experis');
