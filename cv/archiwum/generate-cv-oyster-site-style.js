...
const WEB_PREVIEW = path.join(outputDir, 'oyster_web_preview.html');
const RENDER_HTML = path.join(outputDir, '_oyster_render.html');
const PDF_FILE = path.join(outputDir, 'AG_Oyster_Finance_Operations.pdf');
const VIDEO_FILE = path.join(outputDir, 'AG_Oyster_CV_background.webm');
  ...
  <main class="cv-analyst__container">
    ...
    <section class="cv-analyst__hero">
      <div class="cv-analyst__hero-content">
        ...
        <a class="cv-analyst__role-link" href="${WEB_URL}" target="_blank" rel="noopener">Senior Data Analyst</a>
