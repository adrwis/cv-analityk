"""Helper to write the Mira FP&A / Data Analyst CV generator script."""
import pathlib

JS_PATH = pathlib.Path(__file__).parent / 'generate-cv-mira-data-analyst.js'
...
const cvData = {
  en: {
    fileName: 'AG_Data Analyst_Mira_EN.pdf',
    name: 'Adriana Gusciora',
    title: 'Data Analyst \u00b7 FP&A \u00b7 E-commerce',
    contact: 'Gusciora.Ada@gmail.com | +48 728 884 506 | linkedin.com/in/adriana-gu | Remote (EU-based)',
    summary: 'Data Analyst with 8+ years of experience in financial reporting, FP&A, and data-driven decision-making across global organisations. Proven expertise in working with high data volumes: sales analytics, P&L reporting, cost analysis, budgeting, and forecasting. Skilled at identifying trends, variances, and root causes in complex datasets. Hands-on experience with Advanced Excel, Power BI, Power Query, and Alteryx for automated reporting and financial modelling. Passionate about process improvements and leveraging BI tools to streamline reporting and deliver actionable insights. Strong collaborator comfortable working in fast-paced, international environments with flexible schedules.',
    sections: {
    ...
    jobs: [
      {
        ...
        bullets: [
          'Preparing weekly and monthly financial reports for Financial Directors and CFO: P&L, cost analysis by department, variance flagging vs budget and rolling forecast',
          'Building Alteryx ETL pipelines for data cleansing and multi-source consolidation, handling high data volumes across finance and operations',
          'Automating recurring reports and forecasting workflows (Power Query, Alteryx), reducing manual effort and improving accuracy',
          'Analysing complex datasets to identify trends, variations, and root causes; presenting actionable recommendations to senior stakeholders',
          'Designing Power BI dashboards and scorecards for KPI tracking and executive presentations',
        ],
      },
      {
        ...
        bullets: [
          'Managing financial data for ~40 IT projects worth $15M: budgeting, forecasting, cost review, variance analysis',
          'Preparing ad hoc financial analyses and models: sales analytics, cost breakdowns, resource allocation',
          'Designing automated BI reports (Power BI, SQL, Power Query, Cognos) for cross-regional stakeholders',
          'Maintaining cashflow and rolling forecast files; flagging deviations from budget to senior leadership',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Working with ERP and reporting systems to consolidate data from multiple sources into standardised reports',
      ...
      },
      {
        ...
        bullets: [
          'Building Power BI dashboards for business performance tracking: sales metrics, cost reviews, operational KPIs',
          'Analysing invoice flow and cost data for a banking sector client: identifying trends, flagging deviations, implementing improvements',
          'Budgeting, forecasting, and non-financial analysis for regional operations',
          'Automating reporting with Power Automate and SharePoint, improving data accuracy and delivery cycle time',
        ],
      },
      {
        ...
        bullets: [
          'International experience across Portugal & Poland: sales analytics, logistics KPI reporting, stakeholder coordination in matrix structures',
        ],
      },
    ],
    skillGroups: [
      { name: 'Data Analytics & Reporting', items: 'High-volume data analysis \u00b7 Trend & variance identification \u00b7 Root cause analysis \u00b7 Sales & gross margin analytics \u00b7 KPI tracking \u00b7 Executive presentations' },
      { name: 'Financial Planning & Analysis', items: 'P&L reporting \u00b7 Budgeting & forecasting \u00b7 Rolling forecasts \u00b7 Cashflow planning \u00b7 Cost analysis by department \u00b7 Variance flagging vs budget' },
      { name: 'Software & BI Tools', items: 'Advanced Excel (Power Pivot, complex formulas, financial models) \u00b7 Power BI (dashboards, DAX, data models) \u00b7 Power Query (automated multi-source consolidation) \u00b7 Alteryx (ETL, data cleansing) \u00b7 Cognos' },
      { name: 'Automation & Systems', items: 'Power Automate (workflow automation) \u00b7 PowerApps \u00b7 SharePoint \u00b7 SQL (advanced queries, joins, CTEs) \u00b7 ERP systems experience' },
      { name: 'Collaboration', items: 'Cross-functional teamwork \u00b7 International remote environments \u00b7 Stakeholder management \u00b7 Training & knowledge sharing \u00b7 Process standardisation' },
    ],
    education: [
