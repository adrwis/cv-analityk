// Tailored CV (EN) - BI dashboards / performance reporting Expert (Great Value Hiring, contract, remote).
// Role genre: evaluating AI-generated work products (documents, spreadsheets, PRESENTATIONS)
// against domain-specific quality rubrics; spotting factual, aesthetic and presentation errors;
// delivering clear, structured written feedback. Domain rubric = BI / performance reporting.
// Offer asks: 5+ yrs BI dashboards / performance reporting, fluent English, high proficiency in
// MS Office + Google Workspace (esp. presentation software); preferred: Master's from reputable institution.
// Focus: presentation-grade dashboards/decks/spreadsheets for C-level, output quality & error review,
// AI-tools (Claude) daily + own AI agents, structured written feedback, two master's-level degrees.
// Truthful: NO Python / Databricks / RLS / VBA / DWH claimed.
...
const data = {
  ...
  sidebarSkills: [
    { name: 'BI Dashboards & Performance Reporting', lvl: 'Expert', pct: 93 },
    { name: 'Presentations & Data Storytelling', lvl: 'Expert', pct: 90 },
    { name: 'Output Quality & Error Review', lvl: 'Advanced', pct: 88 },
    { name: 'MS Office & Google Workspace', lvl: 'Expert', pct: 92 },
  ...
  stats: [
    { num: '8+', lbl: 'Years BI &<br>Performance Reporting' },
    { num: '5+', lbl: 'Years Dashboards<br>& Presentations' },
    { num: 'C-suite', lbl: 'Reporting<br>Audience' },
  ...
  jobs: [
    {
      ...
      bullets: [
        'Owned <b>performance and KPI reporting</b> for the CFO and Financial Directors: <b>presentation-grade dashboards, scorecards and decks</b> leadership relied on daily.',
        'Built dashboards and analysis in <b>Power BI and advanced Excel</b>; connected and transformed data from multiple sources with <b>Power Query (M), Alteryx and SQL</b>.',
        'Reviewed reporting outputs for <b>factual accuracy, visual quality and clarity</b>, flagged data and presentation issues, and documented metric definitions and acceptance criteria.',
        'Translated ambiguous questions into <b>clear, well-presented insight</b> and trained business users on self-service reporting.',
      ],
      impact: 'Replaced fragmented reports with one consistent, presentation-ready set of performance KPIs adopted at C-level.',
    },
    {
      title: 'BI / Performance Analyst at HSBC',
      meta: 'Alten Polska Sp. z o.o. · Banking · Krakow / Remote',
      period: 'Jul 2022 - Apr 2024',
      bullets: [
        'Delivered <b>performance and cost reporting</b> across a <b>$15M pool and ~40 IT projects</b> for global bank HSBC: dashboards, scorecards and executive summaries surfacing trends, drivers and outliers.',
        ...
        'Maintained <b>data definitions, documentation and training</b>, keeping every report and presentation accurate, consistent and self-service.',
      ],
      impact: "Consolidated five analysts' inputs into reusable models and one consistent reporting pack.",
    },
    {
      title: 'Reporting & Process Analyst · PowerApps',
      ...
      bullets: [
        ...
        'Built spreadsheet- and SharePoint-based workflows (PowerApps + Power Automate) and <b>validated data across global teams</b>.',
        'Trained global users and developers; set tooling and <b>data-quality and reporting standards</b> as the analytical point of contact.',
      ],
      impact: 'Replaced scattered spreadsheets with a single, consistent reporting source across 14 departments.',
    },
    {
      title: 'BI / Reporting Analyst · Board Reporting',
      meta: 'ISS Facility Services · Project Management · Warsaw',
      period: 'Sep 2018 - May 2021',
      bullets: [
        'Built <b>operational and cost KPI dashboards and Board presentations</b> (Power BI + SharePoint) across service lines.',
        '<b>Budgeting, forecasting and reconciliation</b> for a regulated pharmaceutical client: controlling reporting and variance analysis; <b>managed teams of 4-15</b>.',
        '<b>Analyzed and automated</b> invoice-flow data for a global banking client (Power Automate + SharePoint + Power BI), removing manual steps.',
      ],
      impact: 'Board-level reporting and invoice-flow automation removed recurring manual effort.',
    },
    {
      ...
      bullets: [
        'International experience in <b>Portugal and Poland</b>: Store Excellence, Customer Service, logistics and Employer Branding.',
      ],
      impact: '',
    },
  ],
  ...
  method: [
    ...
    'Presentation-grade outputs',
    'Spot factual & visual errors',
    'Clear, structured written feedback',
    'AI tools and output evaluation',
    'Async, self-directed delivery',
  ],
  toolbox: {
    reporting: { title: 'BI & Performance Reporting', items: 'KPI, performance and management dashboards · scorecards · trend, variance and root-cause analysis · recurring reports for C-level and the Board · 8+ years' },
    presentation: { title: 'Presentations & Documents', items: 'executive presentations and decks · PowerPoint and Google Slides · Word and Google Docs write-ups · advanced Excel and Google Sheets · clear layout and data storytelling' },
    review: { title: 'Output Quality & Review', items: 'assessing documents, spreadsheets and presentations for accuracy, aesthetics and relevance · spotting factual, visual and presentation errors · validating logic and numbers · acceptance criteria · structured written feedback' },
    ai: { title: 'AI & Evaluation', items: 'daily hands-on LLM use (Claude) · building AI agents, scheduled tasks and automation in own projects · evaluating AI-generated outputs against quality rubrics' },
    comms: { title: 'Communication & Insight', items: 'turning ambiguous data into clear insight · concise written communication · async, self-directed delivery · stakeholder storytelling' },
    domain: { title: 'Tools & Background', items: "Microsoft Office & Google Workspace · Power BI · Power Query (M) · SQL · Alteryx · SharePoint · two master's-level degrees (leading Polish institutions) · Lean / Six Sigma" },
  },
  gdpr: GDPR_EN,
...
const offer = {
  fileName: 'AG_Great_Value_Hiring_BI_Reporting_Expert.pdf',
  lang: 'en',
  title: 'BI & Performance Reporting · AI Output Evaluation',
  summary: 'BI and performance-reporting specialist with <strong>8+ years building dashboards, reports and executive presentations</strong> across banking, cybersecurity, medical devices and facilities (HSBC, Trustwave, Zimmer Biomet, ISS). Day to day I turn complex data into <strong>clear, presentation-grade dashboards, decks and spreadsheets for C-level</strong> — and I am exacting about <strong>factual accuracy, visual/aesthetic quality and presentation polish</strong>. I review reporting outputs for errors, validate the logic and numbers behind them, and give <strong>clear, structured written feedback</strong>. Highly proficient in <strong>Microsoft Office and Google Workspace (incl. presentation software)</strong> and Power BI; I use <strong>AI tools (Claude) daily and build my own AI agents</strong>, which makes me a strong fit for <strong>evaluating and improving AI-generated documents, spreadsheets and presentations against quality rubrics</strong>. <strong>Two master\'s-level degrees</strong> from leading Polish institutions; fluent English; structured, detail-driven and self-directed.',
  skillOrder: ['reporting', 'presentation', 'review', 'ai', 'comms', 'domain'],
};
